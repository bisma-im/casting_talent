<!-- <section class="testtimonailsec" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
    ...
    <!--<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">-->
    <!--    <div class="testimonailimg">-->
    <!--        <img src="{{ url('user-assets') }}/images/testimonalimg.png" class="img-fluid" alt="img">-->
    <!--    </div>-->
    <!--</div>-->
...
@if (!in_array(Route::currentRouteName(), ['talents.get']))
    @php
        $testimonials = [
        [
                ...
                <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                    <div class="socaillisnk">
                        <ul>
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/abeera-sheikh-uae-based-casting-specialist-actor-and-founder-of-aks-castings-llc-723063147" target="_blank">
