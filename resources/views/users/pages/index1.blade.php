                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                            <div class="bannerlistimg1">
                                <img src="{{ url('user-assets') }}/images/banner_img_2.jpg" class="img-fluid"
                                    alt="img">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
                            <div class="rightbanner">
                                <div class="bannerlistimg">
                                    <img src="{{ url('user-assets') }}/images/banner_img_1.jpg" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="bannerlistimg">
                                    <img src="{{ url('user-assets') }}/images/banner_img_3.jpg" class="img-fluid"
                                        alt="img">
                                </div>
                            </div>
                        </div>
    ...
    <ul>
        ...
        <li class="col-md-1">
                    <a href="{{ route('modeling-agency.get', ['section' => 'musicians']) }}" >
                        <img src="{{ url('user-assets/icons/musician.png') }}" alt="Musicians Icon" class="icon w-75">
        ...
        <li class="col-md-1 ">
                    <a href="{{ route('modeling-agency.get', ['section' => 'influencers']) }}" >
                        <img src="{{ url('user-assets/icons/influencer.png') }}" alt="Influencers Icon" class="icon w-75 ">
            ...
            <p class="hover-text"> DANCERS & PERFORMERS</p>
                ...
                <li class="col-md-1 text-center">
                    <a href="{{ route('modeling-agency.get', ['section' => 'presenters_emcees']) }}" class="d-flex flex-column align-items-center">
                        <img src="{{ url('user-assets/icons/eventstaff.png') }}" alt="Presenters Icon" class="icon w-75 ">
                ...
                <li class="col-md-1 text-center">
                    <a href="{{ route('modeling-agency.get', ['section' => 'event_staff_ushers']) }}" class="d-flex flex-column align-items-center">
                        <img src="{{ url('user-assets/icons/eventstaff.png') }}" alt="Event Staff Icon" class="icon w-75 ">
        ...
        <li class="col-md-1">
            <a href="{{ route('modeling-agency.get', ['section' => 'photographers_videographers']) }}" class="d-flex flex-column align-items-center"   data-target="tab9">
            <img src="{{ url('user-assets/icons/photo.png') }}"  alt="Photographers Icon" class="icon w-75 "> 
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                            <div class="castingimgright">
                                <img src="{{ url('user-assets') }}/images/castingleft.jpg" class="img-fluid"
                                    alt="img">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                            <div class="castingtype1 firstcast" data-speed="1.2" data-lag="0">
                                <img src="{{ url('user-assets') }}/images/casting_1.jpg" class="img-fluid"
                                    alt="img">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                            <div class="castingtype1 secondcast" data-speed="1.1" data-lag="0">
                                <img src="{{ url('user-assets') }}/images/casting_2.jpg" class="img-fluid"
                                    alt="img">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 col-xxl-2">
                            <div class="castingtype1 thirdcast" data-speed="1.2" data-lag="0">
                                <img src="{{ url('user-assets') }}/images/casting_3.jpg" class="img-fluid"
                                    alt="img">
                            </div>
                        </div>
                    </div>
