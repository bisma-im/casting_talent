...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <section class="modalagencysec2 mt-4" id="fashion-show">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                    <div class="modalimg">
                        <img src="{{ url('user-assets') }}/images/modal_4.jpeg" alt="Casting Image" class="img-fluid">
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                    <div class="modaltext1">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-6">
                <div class="modalimg">
                    <img src="{{ url('user-assets') }}/images/modal_6.jpg" alt="Casting Image" class="img-fluid p-4">
                </div>
            </div>
            <div class="col-6">
                <div class="modaltext1">
