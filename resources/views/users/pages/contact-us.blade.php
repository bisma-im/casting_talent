                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <select id="countryDropdown" class="form-select" name="country"
                                                        required>
                                                        ...
                                                        <option value="Congo (Congo-Kinshasa)">Congo (Congo-Kinshasa)
                                                        </option>
                                                ...
                                                <div class="col-md-4">
                                                    <select id="stateDropdown" class="form-select" name="state"
                                                        required>
