...
@section('admin-content')
    ...
    <div class="d-xl-flex justify-content-between align-items-start">
        <h1 class="fw-bold" style="color: #003C51;">Overview dashboard</h1>
    ...
    @php
        ...
        $models = DB::table('model_details')->count();
            ...
            <div class="tab-content tab-transparent-content">
                <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
                    <div class="row">
                        ...
                        <div class="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <a href="{{ route('admin.models.get') }}" style="text-decoration:none;">
                                    <div class="card-body text-center">
                                        <h5 class="mb-2 text-dark font-weight-normal py-2">Models</h5>
                                        <div
                                            class="dashboard-progress dashboard-progress-3 d-flex align-items-center justify-content-center item-parent my-5 ">
                                            <i
                                                class="mdi mdi-account-group animate-snake icon-md absolute-center text-info"></i>
                                        </div>
                                        <h2 class="mb-4 text-dark font-weight-bold  ">{{ $models }}</h2>
                                    </div>
                                </a>
                            </div>
                        </div>
                                ...
                                <a href="{{ route('admin.queries.get') }}" style="text-decoration:none;">
                                    <div class="card-body text-center">
                                        ...
                                        <div
                                            class="dashboard-progress dashboard-progress-3 d-flex align-items-center justify-content-center item-parent my-5">
                                            <i
                                                class="mdi mdi-home-group animate-snake icon-md absolute-center text-success"></i>
                                        </div>
                                        <h2 class="mb-4 text-dark font-weight-bold">{{ $queries }}</h2>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div class="card">
                                <a href="" style="text-decoration:none;">
                                    <div class="card-body text-center">
                                        <h5 class="mb-2 text-dark font-weight-normal py-2">Bookings</h5>
                                        <div
                                            class="dashboard-progress dashboard-progress-3 d-flex align-items-center justify-content-center item-parent my-5 ">
                                            <i class="mdi mdi-newspaper animate-snake icon-md absolute-center"
